    ...
    return (
    	<div>
			...
			<div style={{marginLeft: "100px"}}>
				...
				<p class="c1"><a href="./images/mnlgscrn.gif"><img src="./images/mnscrn.gif" align="middle" alt="** PLEASE DESCRIBE THIS IMAGE **" /></a>&nbsp;&nbsp;&nbsp;Console Manager Screens&nbsp;&nbsp;&nbsp;<a href="./images/dsklgmnu.gif"><img src="./images/dskmnu.gif" align="middle" alt="** PLEASE DESCRIBE THIS IMAGE **" /></a></p>
				<h5 class="c2">click to enlarge</h5>
				...
				<p class="c1"><a href="./images/dosacclg.gif"><img src="./images/dosacc.gif" align="bottom" alt="** PLEASE DESCRIBE THIS IMAGE **" /></a></p>
				<h5 class="c2">click to enlarge</h5>
				...
				<p class="c1" ><a href="./images/scdllg.gif"><img src="./images/scdl.gif" align="bottom" alt="** PLEASE DESCRIBE THIS IMAGE **" /></a></p>
				<h5 class="c2">click to enlarge</h5>
			</div>
