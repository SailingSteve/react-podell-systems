  ...
  render() {
    return (
    	<div style={{marginLeft: "10px", fontSize: "18px"}}>
			...
			<br/>
			<center><h3>GETTING ROUND ABOUT</h3></center>
			<center>Console Manager let us maneuver through directories in both DOS</center>
			<center>and NetWare partitions from the server console--a very useful feature</center>
			<center>when trying to locate a specific NLM.</center>
			<br/><br/>
			<h3>ADDENDUM, NOT A REPLACEMENT</h3>
