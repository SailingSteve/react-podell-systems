    ...
    return (
    	<div>
			...
			<div style={{marginLeft: "100px"}}>
				<p><a href="./images/quepmssl.gif"><img src="./images/quepmss.gif"></img></a></p>
				<h5><strong><b>click to enlarge</b></strong></h5>
				...
				<p><a href="./images/defpmssl.gif"><img src="./images/defpmss.gif"></img></a></p>
				<h5><strong><b>click to enlarge</b></strong></h5>
